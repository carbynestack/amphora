...
class JwtReaderTest {
  ...
  @Test
  void givenInvalidTokenProvided_whenExtractSubject_thenThrowUnauthorizedException()
      throws UnauthorizedException {
    JwtReader jwtReader = new JwtReader("sub");
    String invalidToken =
        "{\"auth_time\": 1731500449,\n"
            + "  \"exp\": 1731504422,\n"
            + "  \"iat\": 1731500822,\n"
            + "  \"something\": {\n"
            + "    \"what\": \"is this\"\n"
    ...
    assertThrows(
        ...
        () ->
            jwtReader.extractUserIdFromAuthHeader(
                String.format(
                    "header.%s.signature",
                    Base64.toBase64String(invalidDataJson.getBytes(StandardCharsets.UTF_8)))));
  }
