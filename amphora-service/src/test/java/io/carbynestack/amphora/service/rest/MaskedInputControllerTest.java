...
class MaskedInputControllerTest {
  ...
  private final MaskedInputController maskedInputController =
      new MaskedInputController(storageService, jwtReader);
  ...
  void givenArgumentIsNull_whenUpload_thenThrowIllegalArgumentException() {
    IllegalArgumentException iae =
        assertThrows(
            IllegalArgumentException.class, () -> maskedInputController.upload(authHeader, null));
  ...
  void givenMaskedInputDataIsEmpty_whenUpload_thenThrowIllegalArgumentException() {
    ...
    IllegalArgumentException iae =
        assertThrows(
            ...
            () -> maskedInputController.upload(authHeader, maskedInput));
  ...
  void givenSuccessfulRequest_whenUpload_thenReturnCreatedWithExpectedContent() {
    ...
    when(storageService.createSecret(maskedInput, authorizedUserId))
        .thenReturn(secretShareId.toString());
