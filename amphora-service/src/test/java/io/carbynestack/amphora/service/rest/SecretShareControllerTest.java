...
class SecretShareControllerTest {
  ...
  private final SecretShareController secretShareController = new SecretShareController(storageService, outputDeliveryService, jwtReader);
  ...
  @Test
  void givenSuccessfulRequest_whenGetSecretShare_thenReturnOkAndExpectedContent() throws CsOpaException, UnauthorizedException {
    UUID secretId = UUID.fromString("3bcf8308-8f50-4d24-a37b-b0075bb5e779");
  ...
  void givenSuccessfulRequest_whenDeleteSecretShare_thenReturnOk() throws UnauthorizedException, CsOpaException {
    UUID secretId = UUID.fromString("3bcf8308-8f50-4d24-a37b-b0075bb5e779");
    ResponseEntity<Void> actualResponse = secretShareController.deleteSecretShare(authHeader, secretId);
